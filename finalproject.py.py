...
if (ch1=="no"):
        ...
        print("""when You break in to the cabin through a window, you are positioned at the west end of the room. 
                ...
                You look around the room for the key. Do you?""")
        ...
        choice2()
        def paintings():
                print("You look under the paintings but do not find anything. Choose again.")
                choice2()
                if ch2==2:
                        carpets()
                elif ch2==3:
                        drawers()
        def knobs():
                print("""You look at the drawers and look at the drawers without the knobs, you need to play smart,and having prior expierence \n
                         you now look the drawers that do not have knobs, are the drawers 1,3,4,6 and 8.""")
                s = int(input('what do you do...you enter the code...'))
                         
                print(' the safe opens and you find the key to the door that was locked.You then go to the door and insert the key into the keyhole and open the door')
        def choice3():
                        global ch3
        ...
        def drawers():
                print("""You try to open the drawers, you can open only the ones that have knobs, but cannot open the ones without the knobs.\n
                        You do not find anything in the ones you could open. Choose again""")
                choice2()
                if ch2==1:
                        paintings()
                elif ch2==2:
...
One is at the south direction and another at the west direction.
Which door do you open?
        \n
        1)SOUTH direction door
        \n
        2)WEST direction door""")
print()
...
def Door1():
    if Door==1:
       print("""You are planning to enter the third room which is at the south direction.That door is locked by a triangular knob.
...
'Current' word that has been shown on the box. You realise that the password changes in a certain period. You notice that there is a digital board which is showing yesterday's, today's as
well as tommorow's date, including the month and the year.
             ...
             def Password1():
                 ...
                 print('####################################################################################################################################################')
                 print()
                 print("Oh no!The password you entered is wrong and the box shows a redlight and asks you to 'Try again' after 5 minutes. After 5 min,try it by remaining date.")
...
if Door == 1:
     Door1()
        ...
        import time
        print("You open the door at the North end of the room. And enter into ROOM-4")
        print("""You now see that the room is completely empty, except that there is a carving in the wall, you now go near the wall and see that the engravings are in morse code,
...
if s==9988:
 ...
 print('####################################################################################################################################################')
 print()
 print('CONGRATULATIONS!!!!!! WELL DONE AGENT{}. NOW YOR VICTORY IS ASSURED AS LONG AS YOU GET BACK ON TIME...'.format(user))
 time.sleep(1)
 from tkinter import *      
 root = Tk()
 #create a root in gui and locate file location of picture      
 ...
 print()
    ...
    print('you failed to enter the right code AGENT {} YOU WILL NOW FACE IT CONSEQUENCES >>> '.format(user))
    #exit
